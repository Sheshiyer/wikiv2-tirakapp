...
description: Detailed persona for Nok "The Culture Connector" (80% supply-side focus).
category: audience
order: 1
icon: user-check
...
# Buyer Persona Dossier: Tirak Companion
...
| Method | Formal Explanation | Casual / BK Magazine Style |
| :----------- | :----------------------- | :----------------------------- |
